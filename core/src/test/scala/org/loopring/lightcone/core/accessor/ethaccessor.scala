...
import org.loopring.lightcone.core.accessor.{ ContractABI, EthClientImpl }
...
package object ethaccessor {
  ...
  val abi = new ContractABI(config.getConfig("abi"))
  ...
  val geth = new EthClientImpl(config, abi, httpFlow)
