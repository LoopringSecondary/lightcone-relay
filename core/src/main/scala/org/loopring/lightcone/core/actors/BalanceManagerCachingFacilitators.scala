...
object BalanceManagerCachingFacilitators {
  ...
  implicit val getBalancesReqFacilitator =
    new ActorCachingFacilitator[GetBalancesReq, GetBalancesResp, CacheBalanceInfo] {
      def genCacheRequest(
        req: GetBalancesReq,
        uncachedResp: GetBalancesResp
      ...
      def genSourceRequest(
        req: GetBalancesReq,
        cachedResp: GetBalancesResp
      ): Option[GetBalancesReq] = {
  ...
  implicit val getAllowancesReqFacilitator =
    new ActorCachingFacilitator[GetAllowancesReq, GetAllowancesResp, CacheBalanceInfo] {
      def genCacheRequest(
        req: GetAllowancesReq,
        uncachedResp: GetAllowancesResp
      ): Option[CacheBalanceInfo] = {
      ...
      def genSourceRequest(
        req: GetAllowancesReq,
        cachedResp: GetAllowancesResp
      ): Option[GetAllowancesReq] = {
